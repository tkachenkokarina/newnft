(() => {
    ...
    function initSliders() {
        if (document.querySelector(".auctions__slider")) new core(".auctions__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.2,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-button-prev, .actions-auctions__prev",
                nextEl: ".swiper-button-next, .actions-auctions__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 9999,
        ...
        if (document.querySelector(".collections__slider")) new core(".collections__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-button-prev, .media-collections__arrow-prev",
                nextEl: ".swiper-button-next, .media-collections__arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 9999,
